...
export default function VenueBottomSheet({
  ...
  return (
    ...
    >
      ...
      >
        {/* ── Drag handle — tap to collapse or expand ─────────────────── */}
        <div
    ...
    >
      ...
      <div className="p-3 space-y-2">
        <div
          ...
          style={{ width: "75%", backgroundColor: "rgba(42,42,69,0.8)" }}
        />
        <div
          className="h-3 rounded"
          style={{ width: "50%", backgroundColor: "rgba(42,42,69,0.8)" }}
        />
        <div
          className="h-3 rounded"
          style={{ width: "60%", backgroundColor: "rgba(42,42,69,0.8)" }}
        />
      </div>
    </div>
  );
